            ...
            while (correctInput == true)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine("The total of the three numbers in different currencies is as follows:" +
                        ...
                        total.ToString("C", CultureInfo.CreateSpecificCulture("sv-SE")), 
                        total.ToString("C", CultureInfo.CreateSpecificCulture("ja-JP")), 
                        total.ToString("C", CultureInfo.CreateSpecificCulture("th-TH")));
                    correctInput = false;
                }
                catch {Console.WriteLine("Im sorry, one of the responses was invalid response, please try again!"); }
            }
